...
NOSECOVER     = --cover-package=${MODULENAME},janitoo_db,janitoo_dhcp,janitoo_layouts,janitoo_manager --with-coverage --cover-inclusive --cover-html --cover-html-dir=${BUILDDIR}/docs/html/tools/coverage --with-html --html-file=${BUILDDIR}/docs/html/tools/nosetests/index.html
